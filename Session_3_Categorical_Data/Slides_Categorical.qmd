...
3.  Gráfica de barras y circular
...
Hoy nos enfocaremos en visualizar las variables categóricas.
...
Usando las herramientas para gráficos en ggplot, modifica el código anterior para que la gráfica se vea así.
