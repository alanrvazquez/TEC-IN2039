...
## Empezemos con un su instalación
...
Entonces una de las variables es `Condution` si fueron informados de este hecho o no.
...
En este curso, asumiremos que los datos estan almacenados en un archivo Excel con la organización anterior. Por ejemplo, el siguiente archivo muestra .

El archivo se llama .

Para leerlo, el archivo debe de estar en la misma carpeta que tu codigo.

## Libreria `readxl`

Para cargar datos en R, utilizaremos la libreria llamada `readxl` .

Primero, debes de instalar esta libreria en R utilizando el siguiente comando.
...
![](images/clipboard-2627775172.png){fig-align="right" width="332"}

## 

El siguiente código muestra como leer los datos en el archivo `alan.xlsx` en R.

```{r}
#| output: false
#| echo: true

datos_alan <- read_excel()
```
...
-   Trabajaremos con un pequeño subconjunto de estas.

-   La más importante es `ggplot2`.
