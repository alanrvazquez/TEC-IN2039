...
.midi\[ \> Start with the `penguins` data frame, \> map bill depth to the x-axis \> and map bill length to the y-axis. \> **Represent each observation with a point**\]
...
.midi\[ \> Start with the `penguins` data frame, \> map bill depth to the x-axis \> and map bill length to the y-axis. \> Represent each observation with a point \> **and map species to the colour of each point.**\]
...
.midi\[ \> Start with the `penguins` data frame, \> map bill depth to the x-axis \> and map bill length to the y-axis. \> Represent each observation with a point \> and map species to the colour of each point. \> **Title the plot "Bill depth and length"**\]
...
.midi\[ \> Start with the `penguins` data frame, \> map bill depth to the x-axis \> and map bill length to the y-axis. \> Represent each observation with a point \> and map species to the colour of each point. \> Title the plot "Bill depth and length", \> **add the subtitle "Dimensions for Adelie, Chinstrap, and Gentoo Penguins"**\]
